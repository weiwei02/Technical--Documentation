...
### 主内存和工作内存
  ...
  ![](https://weiwei02.coding.me/images/java/jvm/JMM交互关系图.png)
...
volatile 变量具有 synchronized 的可见性特性，但是不具备锁的原子特性。所以即便volatile没有不一致的问题，但volatile变量在并发的运算下并不是原子操作，所以依然可能会有安全问题。
   ...
   程序的执行结果如图2所示。
   ![volatile 线程安全测试](https://weiwei02.coding.me/images/java/jvm/volatile数据错误1.png)
   图2 volatile 线程安全测试
